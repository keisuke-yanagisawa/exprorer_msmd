...
class TestGenerateMsmdSystem(TestCase):
    ...
    def test_generate_msmd_system(self):
        setting = util.parse_yaml("script/test_data/setting.yaml")
        ...
        expected_parm7 = open("script/test_data/tripeptide_A11.parm7").readlines()[1:]
        self.assertEqual(parm7_str, expected_parm7)

        rst7_str = open(rst7).read()
        expected_rst7 = open("script/test_data/tripeptide_A11.rst7").read()
...
class TestCreateFrcmod(TestCase):
    ...
    def test_create_frcmod(self):
        ...
        expected_frcmod = open("script/test_data/A11.frcmod").read()
    ...
    def test_invalid_mol2file(self):
        with self.assertRaises(ValueError):
            _create_frcmod("script/test_data/A11.pdb", self.atomtype)
