...
"""
Quantitative Inverse MSMDの結果を比較するモジュール
"""
...
def save_comparison_result(result1, result2, comparison, output_file):
    """
    比較結果をファイルに保存する
...
def main():
    ...
    # 比較結果を出力
    save_comparison_result(result1, result2, comparison, args.output)
